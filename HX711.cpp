...
<div class="sourcetree-callout clone-in-sourcetree"
  ...
  <div class="secondary-actions">
    <div class="aui-buttons">
        ...
        <a href="/seven7777/5kg_loadsensor_fw/src/938c1cbc7113/HX711_5Kg_new/HX711.cpp?at=master"
           class="aui-button pjax-trigger" aria-pressed="true">
          Source
        </a>
        <a href="/seven7777/5kg_loadsensor_fw/diff/HX711_5Kg_new/HX711.cpp?diff2=938c1cbc7113&at=master"
           class="aui-button pjax-trigger"
           title="Diff to previous change">
          Diff
        </a>
        <a href="/seven7777/5kg_loadsensor_fw/history-node/938c1cbc7113/HX711_5Kg_new/HX711.cpp?at=master"
           class="aui-button pjax-trigger">
          History
        </a>
  ...
  <h1>
        ...
        <a href="/seven7777/5kg_loadsensor_fw/src/938c1cbc7113?at=master"
          class="pjax-trigger root" title="seven7777/5kg_loadsensor_fw at 938c1cbc7113">5KG_LoadSensor_FW</a> /
              ...
              <span class="file-name">HX711.cpp</span>
  ...
  <div class="clearfix"></div>
    ...
    <div id="editor-container" class="maskable"
         ...
         data-branch="master"
         data-path="HX711_5Kg_new/HX711.cpp"
         data-source-url="/api/1.0/repositories/seven7777/5kg_loadsensor_fw/src/938c1cbc7113b987045a621cf17d78d3c04ee1ce/HX711_5Kg_new/HX711.cpp">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/seven7777/5kg_loadsensor_fw/full-commit/938c1cbc7113/HX711_5Kg_new/HX711.cpp" id="full-commit-link"
              title="View full commit 938c1cb">Full commit</a>
          </div>
            <div class="secondary">
              <div class="aui-buttons">
                
                  <a href="/seven7777/5kg_loadsensor_fw/annotate/938c1cbc7113b987045a621cf17d78d3c04ee1ce/HX711_5Kg_new/HX711.cpp?at=master"
                  class="aui-button aui-button-light pjax-trigger">Blame</a>
                
                
                <a href="/seven7777/5kg_loadsensor_fw/raw/938c1cbc7113b987045a621cf17d78d3c04ee1ce/HX711_5Kg_new/HX711.cpp"
...
<a href="#cl-96">96</a>
<a href="#cl-97">97</a>
<a href="#cl-98">98</a></pre></div></td><td class="code"><div class="highlight"><pre><a name="cl-1"></a><span class="cp">#include &quot;hx711.h&quot;</span>
<a name="cl-2"></a>
<a name="cl-3"></a><span class="kt">unsigned</span> <span class="kt">long</span> <span class="n">HX711_Buffer</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="cl-4"></a><span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">Weight_Maopi</span> <span class="o">=</span> <span class="mi">0</span><span class="p">,</span><span class="n">Weight_Shiwu</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="cl-5"></a>
<a name="cl-6"></a><span class="c1">//****************************************************</span>
<a name="cl-7"></a><span class="c1">//初始化HX711</span>
<a name="cl-8"></a><span class="c1">//****************************************************</span>
<a name="cl-9"></a><span class="kt">void</span> <span class="nf">Init_Hx711</span><span class="p">()</span>
<a name="cl-10"></a><span class="p">{</span>
<a name="cl-11"></a>	<span class="n">pinMode</span><span class="p">(</span><span class="n">HX711_SCK</span><span class="p">,</span> <span class="n">OUTPUT</span><span class="p">);</span>	
<a name="cl-12"></a>	<span class="n">pinMode</span><span class="p">(</span><span class="n">HX711_DT</span><span class="p">,</span> <span class="n">INPUT</span><span class="p">);</span>
<a name="cl-13"></a><span class="p">}</span>
<a name="cl-14"></a>
<a name="cl-15"></a>
<a name="cl-16"></a><span class="c1">//****************************************************</span>
<a name="cl-17"></a><span class="c1">//获取毛皮重量</span>
<a name="cl-18"></a><span class="c1">//****************************************************</span>
<a name="cl-19"></a><span class="kt">void</span> <span class="nf">Get_Maopi</span><span class="p">()</span>
<a name="cl-20"></a><span class="p">{</span>
<a name="cl-21"></a>	<span class="n">HX711_Buffer</span> <span class="o">=</span> <span class="n">HX711_Read</span><span class="p">();</span>
<a name="cl-22"></a>	<span class="n">Weight_Maopi</span> <span class="o">=</span> <span class="n">HX711_Buffer</span><span class="o">/</span><span class="mi">100</span><span class="p">;</span> <span class="c1">// No load value		</span>
<a name="cl-23"></a><span class="p">}</span> 
<a name="cl-24"></a>
<a name="cl-25"></a>
<a name="cl-26"></a><span class="c1">//****************************************************</span>
<a name="cl-27"></a><span class="c1">//称重</span>
<a name="cl-28"></a><span class="c1">//****************************************************</span>
<a name="cl-29"></a><span class="kt">unsigned</span> <span class="kt">int</span> <span class="nf">Get_Weight</span><span class="p">()</span>
<a name="cl-30"></a><span class="p">{</span>
<a name="cl-31"></a>	<span class="n">HX711_Buffer</span> <span class="o">=</span> <span class="n">HX711_Read</span><span class="p">();</span>
<a name="cl-32"></a>	<span class="n">HX711_Buffer</span> <span class="o">=</span> <span class="n">HX711_Buffer</span><span class="o">/</span><span class="mi">100</span><span class="p">;</span>
<a name="cl-33"></a>        <span class="n">Serial</span><span class="p">.</span><span class="n">print</span><span class="p">(</span><span class="s">&quot;HX711 Value: &quot;</span><span class="p">);</span>
<a name="cl-34"></a>	<span class="n">Serial</span><span class="p">.</span><span class="n">print</span><span class="p">(</span><span class="n">HX711_Buffer</span><span class="p">);</span>
<a name="cl-35"></a>	<span class="n">Serial</span><span class="p">.</span><span class="n">print</span><span class="p">(</span><span class="s">&quot;</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">);</span>
<a name="cl-36"></a>	<span class="k">if</span><span class="p">(</span><span class="n">HX711_Buffer</span> <span class="o">&gt;</span> <span class="n">Weight_Maopi</span><span class="p">)</span>			
<a name="cl-37"></a>	<span class="p">{</span>
<a name="cl-38"></a>		<span class="n">Weight_Shiwu</span> <span class="o">=</span> <span class="n">HX711_Buffer</span><span class="p">;</span>
<a name="cl-39"></a>		<span class="n">Weight_Shiwu</span> <span class="o">=</span> <span class="n">Weight_Shiwu</span> <span class="o">-</span> <span class="n">Weight_Maopi</span><span class="p">;</span>				<span class="c1">//获取实物的AD采样数值。</span>
<a name="cl-40"></a>	
<a name="cl-41"></a>		<span class="n">Weight_Shiwu</span> <span class="o">=</span> <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">int</span><span class="p">)((</span><span class="kt">float</span><span class="p">)</span><span class="n">Weight_Shiwu</span><span class="o">/</span><span class="mf">4.05</span><span class="o">+</span><span class="mf">0.05</span><span class="p">);</span> 	
<a name="cl-42"></a>			<span class="c1">//计算实物的实际重量</span>
<a name="cl-43"></a>			<span class="c1">//因为不同的传感器特性曲线不一样，因此，每一个传感器需要矫正这里的4.30这个除数。</span>
<a name="cl-44"></a>			<span class="c1">//当发现测试出来的重量偏大时，增加该数值。</span>
<a name="cl-45"></a>			<span class="c1">//如果测试出来的重量偏小时，减小改数值。</span>
<a name="cl-46"></a>			<span class="c1">//该数值一般在4.0-5.0之间。因传感器不同而定。</span>
<a name="cl-47"></a>			<span class="c1">//+0.05是为了四舍五入百分位</span>
<a name="cl-48"></a>	<span class="p">}</span>
<a name="cl-49"></a>        <span class="k">else</span>
<a name="cl-50"></a>        <span class="p">{</span>
<a name="cl-51"></a>          <span class="c1">// over the measurement range (too heavy or too light)</span>
<a name="cl-52"></a>      	  <span class="k">if</span><span class="p">(</span><span class="n">Weight_Shiwu</span> <span class="o">&gt;</span> <span class="mi">5000</span> <span class="o">||</span> <span class="n">HX711_Buffer</span> <span class="o">&lt;</span> <span class="n">Weight_Maopi</span> <span class="o">-</span> <span class="mi">30</span><span class="p">)</span>
<a name="cl-53"></a>      	  <span class="p">{</span>
<a name="cl-54"></a>      		<span class="n">Serial</span><span class="p">.</span><span class="n">print</span><span class="p">(</span><span class="s">&quot;Error&quot;</span><span class="p">);</span>
<a name="cl-55"></a>      	  <span class="p">}</span>
<a name="cl-56"></a>          <span class="k">else</span>
<a name="cl-57"></a>          <span class="p">{</span>
<a name="cl-58"></a>             <span class="c1">// 0 g </span>
<a name="cl-59"></a>             <span class="n">Weight_Shiwu</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>        
<a name="cl-60"></a>          <span class="p">}</span>          
<a name="cl-61"></a>        <span class="p">}</span>
<a name="cl-62"></a>	<span class="k">return</span> <span class="n">Weight_Shiwu</span><span class="p">;</span>
<a name="cl-63"></a><span class="p">}</span>
<a name="cl-64"></a>
<a name="cl-65"></a><span class="c1">//****************************************************</span>
<a name="cl-66"></a><span class="c1">//读取HX711</span>
<a name="cl-67"></a><span class="c1">//****************************************************</span>
<a name="cl-68"></a><span class="kt">unsigned</span> <span class="kt">long</span> <span class="nf">HX711_Read</span><span class="p">(</span><span class="kt">void</span><span class="p">)</span>	<span class="c1">//增益128</span>
<a name="cl-69"></a><span class="p">{</span>
<a name="cl-70"></a>	<span class="kt">unsigned</span> <span class="kt">long</span> <span class="n">count</span><span class="p">;</span> 
<a name="cl-71"></a>	<span class="kt">unsigned</span> <span class="kt">char</span> <span class="n">i</span><span class="p">;</span>
<a name="cl-72"></a>	<span class="kt">bool</span> <span class="n">Flag</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="cl-73"></a>
<a name="cl-74"></a>	<span class="n">digitalWrite</span><span class="p">(</span><span class="n">HX711_DT</span><span class="p">,</span> <span class="n">HIGH</span><span class="p">);</span>
<a name="cl-75"></a>	<span class="n">delayMicroseconds</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<a name="cl-76"></a>
<a name="cl-77"></a>	<span class="n">digitalWrite</span><span class="p">(</span><span class="n">HX711_SCK</span><span class="p">,</span> <span class="n">LOW</span><span class="p">);</span>
<a name="cl-78"></a>	<span class="n">delayMicroseconds</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<a name="cl-79"></a>
<a name="cl-80"></a>  	<span class="n">count</span><span class="o">=</span><span class="mi">0</span><span class="p">;</span> 
<a name="cl-81"></a>  	<span class="k">while</span><span class="p">(</span><span class="n">digitalRead</span><span class="p">(</span><span class="n">HX711_DT</span><span class="p">));</span> 
<a name="cl-82"></a>  	<span class="k">for</span><span class="p">(</span><span class="n">i</span><span class="o">=</span><span class="mi">0</span><span class="p">;</span><span class="n">i</span><span class="o">&lt;</span><span class="mi">24</span><span class="p">;</span><span class="n">i</span><span class="o">++</span><span class="p">)</span>
<a name="cl-83"></a>	<span class="p">{</span> 
<a name="cl-84"></a>	  	<span class="n">digitalWrite</span><span class="p">(</span><span class="n">HX711_SCK</span><span class="p">,</span> <span class="n">HIGH</span><span class="p">);</span> 
<a name="cl-85"></a>		<span class="n">delayMicroseconds</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<a name="cl-86"></a>	  	<span class="n">count</span><span class="o">=</span><span class="n">count</span><span class="o">&lt;&lt;</span><span class="mi">1</span><span class="p">;</span> 
<a name="cl-87"></a>		<span class="n">digitalWrite</span><span class="p">(</span><span class="n">HX711_SCK</span><span class="p">,</span> <span class="n">LOW</span><span class="p">);</span> 
<a name="cl-88"></a>		<span class="n">delayMicroseconds</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<a name="cl-89"></a>	  	<span class="k">if</span><span class="p">(</span><span class="n">digitalRead</span><span class="p">(</span><span class="n">HX711_DT</span><span class="p">))</span>
<a name="cl-90"></a>			<span class="n">count</span><span class="o">++</span><span class="p">;</span> 
<a name="cl-91"></a>	<span class="p">}</span> 
<a name="cl-92"></a> 	<span class="n">digitalWrite</span><span class="p">(</span><span class="n">HX711_SCK</span><span class="p">,</span> <span class="n">HIGH</span><span class="p">);</span> 
<a name="cl-93"></a>	<span class="n">delayMicroseconds</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<a name="cl-94"></a>	<span class="n">digitalWrite</span><span class="p">(</span><span class="n">HX711_SCK</span><span class="p">,</span> <span class="n">LOW</span><span class="p">);</span> 
<a name="cl-95"></a>	<span class="n">delayMicroseconds</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
<a name="cl-96"></a>	<span class="c1">//count ^= 0x800000;</span>
<a name="cl-97"></a>	<span class="k">return</span><span class="p">(</span><span class="n">count</span><span class="p">);</span>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/seven7777/5kg_loadsensor_fw/src/[[changeset]]/HX711_5Kg_new/HX711.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/seven7777/5kg_loadsensor_fw/src/[[changeset]]/HX711_5Kg_new/HX711.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
  ...
  <ul>
    ...
    <li>
      <a class="support-ga" target="_blank"
         ...
         href="#">fc0cb8a00976 / fc0cb8a00976 @ app18</a>
    </li>
  </ul>
</div>
...
<div class="ap-container-onload"
     id="ap-namespace"
     data-source="https://ace-cdn.atlassian.com/stp/current/dialog/ace-stp-dialog-bitbucket.html?xdm_e=https%3A%2F%2Fbitbucket.org&amp;xdm_c=channel-dd6ee7e0-5d70-47c1-be43-9ee3adfaffa2&amp;jwt=eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJpc3MiOiAiY29ubmVjdGlvbjozODc3OCIsICJpYXQiOiAxNDIzMDYzMTU0LCAicXNoIjogImM5ZGI5N2U3M2E1ZmU0ZTczZmY2NjFkYWVmYzk4OTU1MWE2NmE4NTdmMmY1ZTBjYjUxYjg2MjU0NzYwMjg5MzUiLCAiYXVkIjogImNvbm5lY3Rpb246Mzg3NzgiLCAiZXhwIjogMTQyNjY2MzE1NH0.YNZTSY3Zq9ro6CsnbsLODqMCs_mfRqyYUpxt230b-QQ" data-key="help-panel"
